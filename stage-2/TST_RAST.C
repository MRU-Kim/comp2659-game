...
int main()
{
	...
	plot16Bitmap(base, DinoStand, 320, -15, DinoHeight);
	Cnecin();
	clear16Bitmap(base, DinoStand, 320, -15, DinoHeight);
	Cnecin(); /*plot and clear mostly left of screen*/
	plot16Bitmap(base, DinoStand, -15, DinoY, DinoHeight);
	Cnecin();
	clear16Bitmap(base, DinoStand, -15, DinoY, DinoHeight);
	Cnecin(); /*plot and clear mostly right of screen*/
	plot16Bitmap(base, DinoStand, 639 + 14, DinoY, DinoHeight);
	Cnecin();
	clear16Bitmap(base, DinoStand, 639 + 14, DinoY, DinoHeight);
	Cnecin(); /*plot and clear mostly below of screen*/
	plot16Bitmap(base, DinoStand, DinoX, 397, DinoHeight);
	Cnecin();
	clear16Bitmap(base, DinoStand, DinoX, 397, DinoHeight);
	Cnecin();
